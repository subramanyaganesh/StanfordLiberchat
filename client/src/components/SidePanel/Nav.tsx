                            ...
                            <button
                              className={cn(
                                ...
                                variant === 'default'
                                  ...
                                  : '',
                                'hover:bg-gray-200 data-[state=open]:bg-red-600 data-[state=open]:text-black dark:hover:bg-red-600 dark:data-[state=open]:bg-gray-700 dark:data-[state=open]:text-white',
                                'w-full justify-start rounded-md border dark:border-gray-700 bg-red-500 hover:bg-red-600',
                              )}
                              onClick={(e) => {
                                if (link.onClick) {
                                  link.onClick(e);
