                            ...
                            <button
                              className={cn(
                                ...
                                variant === 'default'
                                  ...
                                  : '',
                                'hover:bg-gray-200 data-[state=open]:bg-red-600 data-[state=open]:text-black dark:hover:bg-red-600 dark:data-[state=open]:bg-red-600 dark:data-[state=open]:text-white',
