...
const NewChatButtonIcon = ({ conversation }: { conversation: TConversation | null }) => {
  ...
  if (searchQuery) {
    return (
      <div className="shadow-stroke relative flex h-7 w-7 items-center justify-center rounded-full bg-white text-white dark:bg-white">
    ...
    <TooltipProvider delayDuration={250}>
      <Tooltip>
        <div className="sticky left-0 right-0 top-0 z-20 bg-surface-primary-alt pt-3.5 ">
          <div className="bg-red-500 dark:bg-red-700 pb-0.5 last:pb-0" style={{ transform: 'none' }}>
            <a
              href="/"
              tabIndex={0}
            ...
            >
              ...
              <div className="text-token-text-white grow overflow-hidden text-ellipsis whitespace-nowrap text-sm">
