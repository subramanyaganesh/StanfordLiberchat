    ...
    <TooltipProvider delayDuration={250}>
      <Tooltip>
        <div
          data-testid="nav"
          className={
            'nav active max-w-[320px] flex-shrink-0 overflow-x-hidden bg-gray-50 dark:bg-surface-primary-alt md:max-w-[260px]'
          }
          style={{
          ...
          <div className="h-full w-[320px] md:w-[260px]">
            <div className="flex h-full min-h-0 flex-col">
              ...
              >
                <div
                  className={cn(
                    'scrollbar-trigger relative h-full w-full flex-1 items-start',
                  )}
                >
                  <nav
                    id="chat-history-nav"
                    aria-label={localize('com_ui_chat_history')}
                    className="border-r-2 border-r-red-500 flex h-full w-full flex-col px-3 pb-3.5"
                  >
                    <div
                      className={cn(
